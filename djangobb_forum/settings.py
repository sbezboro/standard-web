...
FORUM_PAGE_SIZE = get('DJANGOBB_FORUM_PAGE_SIZE', 30)
SEARCH_PAGE_SIZE = get('DJANGOBB_SEARCH_PAGE_SIZE', 20)
USERS_PAGE_SIZE = get('DJANGOBB_USERS_PAGE_SIZE', 20)
AVATARS_UPLOAD_TO = get('DJANGOBB_AVATARS_UPLOAD_TO', 'static/djangobb_forum/avatars')
AVATAR_WIDTH = get('DJANGOBB_AVATAR_WIDTH', 110)
AVATAR_HEIGHT = get('DJANGOBB_AVATAR_HEIGHT', 110)
...
POST_USER_SEARCH = get('DJANGOBB_POST_USER_SEARCH', 0)

# GRAVATAR Extension
GRAVATAR_SUPPORT = get('DJANGOBB_GRAVATAR_SUPPORT', False)
...
ATTACHMENT_UPLOAD_TO = get('DJANGOBB_ATTACHMENT_UPLOAD_TO', 'static/djangobb_forum/attachments')
